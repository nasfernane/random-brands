...
<body>
    <div class=mainWrap>
        ...
        $brands = ['Coca-Cola', 'Nike', 'Chanel', 'Bentley', 'Prada', 'Logitech', 'Tesla', 'Guiness', 'Victorinox', 'MSI', 'Razer', 'Etnies', 'Vans', 'Timberland', 'Peugeot', 'Disney', 'Paramount', 'Subway', 'Nvidia', 'Evian', 'Samsung', 'Honor', 'Lu', 'Ankama', 'Hachette', 'Netflix', 'Apple', 'Bose', 'Nicolas', 'Superdry', 'Valrhona', 'Facebook', 'Opquast'];
